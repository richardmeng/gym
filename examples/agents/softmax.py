...
class QLearner(object):
    def __init__(self,
        ...
        self.temprature_decay_rate = temprature_decay_rate
        self.state = 0
        self.action = 0
    ...
    def move(self, state_prime, reward):
        ...
        temprature = self.temprature * self.temprature_decay_rate
        expo_a1 = np.exp(qtable[state_prime][0]*1.0/temprature)
        expo_a2 = np.exp(qtable[state_prime][1]*1.0/temprature)
        
        prob_a1 = expo_a1 / (expo_a1 + expo_a2)
        
        if np.random.uniform(0,1) < prob_a1:
            action_prime = 0
        else:
            action_prime = 1
